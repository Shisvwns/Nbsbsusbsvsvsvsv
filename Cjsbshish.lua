...
ImageButton1.BackgroundColor3 = Color3.fromRGB(24, 24, 24)
...
local Setting = Window:AddTab({Title = "Tab Setting", Icon = "settings"})
local Farm = Window:AddTab({Title = "Tab Farm", Icon = "sword"})
local FruitRaid = Window:AddTab({Title = "Tab Fruits & Raid", Icon = "banana"})
local Other = Window:AddTab({Title = "Tab Misc", Icon = "boxes"})
local ItemQuest = Window:AddTab({Title = "Tab Item & Quest", Icon = "axe"})
local Player = Window:AddTab({Title = "Tab Local Player", Icon = "person-standing"})
local PvP = Window:AddTab({Title = "Tab PvP", Icon = "swords"})
local Sea = Window:AddTab({Title = "Tab Sea Event", Icon = "anchor"})
local Hold = Window:AddTab({Title = "Tab Hold & Use Skill", Icon = "alarm-clock"})
local Race = Window:AddTab({Title = "Tab Upgrade Race", Icon = "user-cog"})
local StatsEsp = Window:AddTab({Title = "Tab Stats & Esp", Icon = "arrow-big-up"})
local Teleport = Window:AddTab({Title = "Tab Teleport", Icon = "map-pin"})
local StatusServer = Window:AddTab({Title = "Tab Status & Server", Icon = "server"})
local Shop = Window:AddTab({Title = "Tab Shop", Icon = "shopping-bag"})

--= [ Tab Setting ] =--

Setting:AddSection("~ Setting Farm ~")

local SelectWeapon = Setting:AddDropdown("SelectWeapon", {
    Title = "Select Weapon",
    Values = {"Melee","Sword","Gun","Blox Fruit"},
    Multi = false,
    Default = "Melee",
})
SelectWeapon:OnChanged(function(Cac)
...
local AttackSpeed = Setting:AddDropdown("AttackSpeed", {
...
AttackSpeed:OnChanged(function(Cac)
    _G.AttackSpeed = Cac
...
local FastAttack = Setting:AddToggle("FastAttack", {Title = "Fast Attack", Default = true })
FastAttack:OnChanged(function(Cac)
    Fast_Attack = Cac
	DamageAura = Cac
	ClickNoCooldown = Cac
...
local SelectMob = Setting:AddDropdown("SelectMob", {
...
local BringMob = Setting:AddToggle("BringMob", {Title = "Bring Mob", Default = true })
FastAttack:OnChanged(function(Cac)
    _G.BringMobs = Cac
end)
...
local SelectLevelMode = Farm:AddDropdown("SelectLevelMode", {
    Title = "Select Farm Level Mode",
    Values = {"No Quest","Get Quest"},
    Multi = false,
    Default = "Get Quest",
})
SelectLevelMode:OnChanged(function(Cac)
    _G.LevelMode = Cac
end)

local FarmLevel = Setting:AddToggle("FarmLevel", {Title = "Farm Level", Default = false })
FarmLevel:OnChanged(function(Cac)
    _G.FarmLevel = Cac
