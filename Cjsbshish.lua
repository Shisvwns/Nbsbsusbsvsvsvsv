...
local Window =OrionLib:MakeWindow({Name = ":)", IntroEnabled = false, IntroText = "Tinh Linh Hub", IntroIcon = "rbxassetid://16730867128", HidePremium = false, SaveConfig = true, ConfigFolder = "TinhLinhHub"})
