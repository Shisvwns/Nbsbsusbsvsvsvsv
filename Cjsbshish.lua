...
function topos(Pos)
    ...
    Tween = game:GetService("TweenService"):Create(lp.Character.PartTele, TweenInfo.new(Distance / _G.TweenSpeed, Enum.EasingStyle.Linear),{CFrame = CFrame.new(Pos)})
    Tween:Play() 
    Clip = true
end
...
function StopTween(target)
    if not target then
        ...
        game:GetService("TweenService"):Create(lp.Character.PartTele, TweenInfo.new(Distance / _G.TweenSpeed, Enum.EasingStyle.Linear),{CFrame = CFrame.new(Pos)}):Cancel()
        Clip = false
    end
end
...
if World1 then
    ChonDao = {"WindMill","Marine","Middle Town","Jungle","Pirate Village","Desert","Snow Island","MarineFord","Colosseum","Sky Island 1","Sky Island 2","Sky Island 3","Prison","Magma Village","Under Water Island","Fountain City","Shank Room","Mob Island"}
elseif Word2 then
