...
function topos(Pos)
    ...
    if _G.BypassTele == true then
        if CalcDistance(Pos) - CalcDistance(Spawn, Pos) > 1000 and CalcDistance(Spawn) > 1000 then
            return _G.BypassTeleport(Spawn)
        end
    end
            ...
            pcall(function()
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    if _G.AutoFarmMob and SelectMag then
                        if v.Name == _G.SelectMob and (v.HumanoidRootPart.Position - PosMonFarm.Position).Magnitude <= 300 then
...
spawn(function()
    while wait() do
        if _G.LevelFMode == "No Quest" and _G.AutoFarm then
            pcall(function()
                CheckQuest()
...
spawn(function()
    while wait() do
        if _G.LevelFMode == "Get Quest" and _G.AutoFarm then
            pcall(function()
...
spawn(function()
    while wait() do
        if _G.CakeFMode == "No Quest" and _G.AutoDoughtBoss then
            pcall(function()
...
spawn(function()
    while wait() do
        if _G.CakeFMode == "Get Quest" and _G.AutoDoughtBoss and World3 then
            pcall(function()
...
spawn(function()
    while wait() do
        if _G.CakeFMode == "Get Quest" and _G.AutoDoughtBoss and World3 and not game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") then
            pcall(function()
                local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
...
spawn(function()
    while wait() do 
        if _G.BoneFMode == "No Quest" and _G.Auto_Bone and World3 then
            pcall(function()
...
spawn(function()
    while wait() do
        if _G.BoneFMode == "Get Quest" and _G.Auto_Bone and World3  then
            pcall(function()
                local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
...
spawn(function()
    while wait() do
        if _G.ModeBoss == "No Quest" and _G.AutoFarmBoss then
            pcall(function()
                CheckBossQuest()
...
spawn(function()
	while wait() do
		if _G.ModeBoss == "Get Quest" and _G.AutoFarmBoss then
			pcall(function()
				CheckBossQuest()
...
spawn(function()
    while wait() do
        if _G.SelectMaterial == "Ectoplasm" and _G.AutoMaterial then
            pcall(function()
...
spawn(function()
	while task.wait() do
		if _G.SelectWeaponTrials == _G.SelectWeaponTrials then
			for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
				if v.ToolTip == _G.SelectWeaponTrials then
					if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.SelectBoatBuy == "Pirate Sloop" then
                _G.BuyBoat = "PirateSloop"
            else
                if _G.SelectBoatBuy == "Enforcer" then
                    _G.BuyBoat = "Enforcer"
                else
                    if _G.SelectBoatBuy == "Rocket Boost" then
                        _G.BuyBoat = "RocketBoost"
                    else
                        if _G.SelectBoatBuy == "Pirate Basic" then
                            _G.BuyBoat = "PirateBasic"
                        else
                            if _G.SelectBoatBuy == "Pirate Brigade" then
                                _G.BuyBoat = "PirateBrigade"
                            end
                        end
                    end
                end
...
Shop:AddButton({
    Name = "Buy Boats",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBoat",_G.BuyBoat)
    end
})
