...
local Window = OrionLib:MakeWindow({Name = "Tinh Linh Hub", IntroEnabled = true, IntroText = "Welcome To Tinh Linh Hub Script", IntroIcon = "rbxassetid://16730867128", HidePremium = false, SaveConfig = true, ConfigFolder = "TinhLinhHub"})
