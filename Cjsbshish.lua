...
Setting:AddSection("~ Setting Farm ~", true)
...
Setting:AddSection("~ Graphic & Reduce Lag ~", true)
...
Setting:AddSection("~ Hold Skill Mastery ~", true)

Setting:AddLabel("Hold Skill Devil Fruit")

-- Wait Update

Setting:AddSection("~ Hold Skill Sea Event ~", true)
