...
local Window = OrionLib:MakeWindow({Name = "NIGHT HUB", HidePremium = false, IntroText = "Loading setting", SaveConfig = true, ConfigFolder = "ConfigSetting"})
...
W:AddLabel("Script By LMNGAMING X VuQuocOai")
...
W:AddLabel("[+] Fix Auto Dual Cursed Katana")
        ...
        if _G.BringMode then
            pcall(function()
                ...
                elseif _G.BringMode == "Normal" then
                    _G.BringMode = 300
                elseif _G.BringMode == "Super Bring(Lag)" then
                    _G.BringMode = 350
                end
            end)
        end
...
local AttackList = {"Super Fast Attack", "0", "0.1", "0.15", "0.155", "0.175", "0.2", "0.3"}
...
spawn(function()
    ...
    M:AddToggle({
        Name = "Auto Chest[Bypass(Kick 30%)]",
        Default = false,
        Callback = function(Value)
...
local CavandisPos = CFrame.new(5311.07421875, 426.0243835449219, 165.12762451171875)
    ...
    spawn(function()
        ...
        local Elite_Hunter_Status = IQ:AddLabel("Status")
                ...
                for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.Name) then
                        repeat wait()
                            ...
                            EquipWeapon(_G.SelectWeapon)
                            Useskill = true
                            topos(v.HumanoidRootPart.CFrame * CFrame.new(1,0,3))								
                            v.HumanoidRootPart.Size = Vector3.new(60,60,60)
                            game:GetService'VirtualUser':CaptureController()
                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
