...
Tabs.Main:AddParagraph({
    Title = "Misc Farm",
    Content = "Bone & Cake Prince & Ectopplasm"
})
...
--Setting
    ...
    local SliderFastAttack = Tabs.Setting:AddSlider("SliderFastAttack", {
        Title = "Delay Fast Attack",
        Description = "Fast Attack Deley",
        Default = 0.3,
        Min = 0,
        Max = 5,
        Rounding = 1,
    ...
    SliderFastAttack:OnChanged(function(Value)
      _G.Fast_Delay = Value
    end)
    SliderFastAttack:SetValue(0.3)
...
Tabs.Setting:AddParagraph({
    Title = "Setting Distance Farm",
    Content = "Distance Farm"
})
--------------------------------------------------------------------------------------------------------------------------------------------
...
Tabs.Raid:AddParagraph({
    Title = "Raid Law",
    Content = "Auto Buy Chip And Spawn Boss Law"
})
...
Tabs.Race:AddParagraph({
    Title = "Auto Race",
    Content = "Tp to door and complete trial"
})
