...
local SkipLevel = Tabs.Farm:AddToggle("SkipLeve", {Title = "Auto Farm Level Fast [ Lv.1 -> Lv.300 ]", Default = false })
Options.SkipLeve:SetValue(false)
SkipLevel:OnChanged(function(Value)
    _G.Farmfast = Value
